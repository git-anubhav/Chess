...
public class TakenPiecesPanel extends JPanel {
    ...
    private static final Color PANEL_COLOR = Color.decode("#CBD9E0");
    ...
    public void redo(final MoveLog moveLog) {
         ...
         for(final Move move : moveLog.getMoves()) {
             if(move.isAttack()) {
                 ...
                 if (takenPiece.getPieceAlliance().isWhite()){
                     ...
                     throw new RuntimeException("Congrats you have a GRAY piece!");
                 }
             }
         }
        ...
        for (final Piece takenPiece : whiteTakenPieces) {
            try {
                ...
                final JLabel imageLabel = new JLabel(new ImageIcon(icon.getImage().getScaledInstance(icon.getIconWidth() - 40, icon.getIconHeight() - 40, Image.SCALE_SMOOTH)));
